<%@taglib prefix="security"
	uri="http://www.springframework.org/security/tags"%><b> <script>
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li id="listProducts" class="dropdown"><a
						...
						href="${contextRoot}/show/all/products">View Products <span
							class="caret"></span>
					</a> <%@include file="sidebar.jsp"%></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<security:authorize access="isAuthenticated()">
						<li class="dropdown" id="userModel"><a
							...
							aria-expanded="true"> <b>${userModel.fullName}</b> <span
								class="caret"></span>
						</a>
