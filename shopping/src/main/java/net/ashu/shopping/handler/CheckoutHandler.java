package net.ashu.shopping.handler;
...
import net.ashu.backend.dao.UserDAO;
import net.ashu.backend.dto.Address;
import net.ashu.backend.dto.Cart;
import net.ashu.backend.dto.CartLine;
import net.ashu.backend.dto.OrderDetail;
import net.ashu.backend.dto.OrderItem;
import net.ashu.backend.dto.Product;
import net.ashu.backend.dto.User;
import net.ashu.shopping.model.CheckoutModel;
import net.ashu.shopping.model.UserModel;
